...
import { Calendar, User, ArrowLeft, Clock, Play, ArrowRight } from "lucide-react";
      ...
      <div className="pt-20 pb-16 bg-white dark:bg-gray-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <article className="bg-white dark:bg-gray-900">
            ...
            {/* CTA Section */}
            <div className="mt-12 pt-8 pb-8 border-t border-gray-100 dark:border-gray-800">
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-6 border border-blue-100 dark:border-blue-800/50">
                <div className="text-center">
                  <h3 className="text-xl font-normal mb-2 text-gray-900 dark:text-gray-100">
                    Ready to Start Creating?
                  </h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                    Transform your ideas into amazing video content with Sora2 AI
                  </p>
                  <Link href="/text-to-video">
                    <Button 
                      className="bg-primary hover:bg-primary/90 text-primary-foreground font-normal px-8 py-6 text-base shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105"
                    >
